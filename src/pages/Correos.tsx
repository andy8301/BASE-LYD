          ...
          <form onSubmit={manejarEnviar} className="space-y-4 pt-2">
            ...
            {mostrarCamposExtras && (
              <div className="space-y-4 pt-2 border-t border-dashed border-slate-200 mt-2 animate-in fade-in duration-200">
                ...
                {/* SELECT DE TIPO DE TRÁMITE COMPLETAMENTE CORREGIDO EN ESTILOS Y VALORES */}
                <div>
                  ...
                  >
                    ...
                    <option value="Exencion">Exencion</option>
                    <option value="Devolucion">Devolucion</option>
                    <option value="copia boleta fiscal">copia boleta fiscal</option>
