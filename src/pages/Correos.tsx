...
// Agregamos el tipo string[] para que TypeScript no ponga problema
...
export default function Correos() {
  ...
  // Estado inicial tipado de forma segura con any para evitar conflictos con Google Sheets
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="sm:max-w-[750px] max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={manejarEnviar} className="space-y-4 pt-2">
            ...
            {/* CAMPO DE SELECT PARA EVITAR COMPLICACIONES */}
            <div>
